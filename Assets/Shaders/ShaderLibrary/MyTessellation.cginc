...
bool TriangleIsCulled (float3 p0, float3 p1, float3 p2, float bias)
{
    ...
    return 
        TriangleBelowClipPlane(p0, p1, p2, 0, bias) ||
        TriangleBelowClipPlane(p0, p1, p2, 1, bias) ||
        TriangleBelowClipPlane(p0, p1, p2, 2, bias) ||
        TriangleBelowClipPlane(p0, p1, p2, 3, bias);
}
