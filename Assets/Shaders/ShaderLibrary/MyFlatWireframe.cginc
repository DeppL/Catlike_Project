// Upgrade NOTE: upgraded instancing buffer 'InstancePropertise' to new syntax.

// Upgrade NOTE: replaced 'mul(UNITY_MATRIX_MVP,*)' with 'UnityObjectToClipPos(*)'

#ifndef FLAT_WIREFRAME_INCLUDED
...
float3 GetAlbedoWithWireframe (Interpolators i)
{
	...
	float3 deltas = fwidth(barys); // float delta = abs(ddx(minBary)) + abs(ddy(minBary));
