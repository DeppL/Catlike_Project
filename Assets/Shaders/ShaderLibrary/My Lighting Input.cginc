...
// float4 _Tint;
UNITY_INSTANCING_BUFFER_START(InstancePropertise)
// float4 _Color;
	UNITY_DEFINE_INSTANCED_PROP(float4, _Color)
#define _Color_arr InstancePropertise
UNITY_INSTANCING_BUFFER_END(InstancePropertise)
...
#endif // MY_LIGHTING_INPUT_INCLUDED