Shader "Custom/Tessellation" {
	...
	SubShader {
		...
		Pass {
			...
			// #pragma instancing_options maxcount:500
			...
			#include "../ShaderLibrary/My Lighting.cginc"
			#include "../ShaderLibrary/MyTessellation.cginc"
		...
		Pass {
			...
			#include "../ShaderLibrary/My Shadows.cginc"
			#include "../ShaderLibrary/MyTessellation.cginc"
		...
		Pass {
			...
			#include "../ShaderLibrary/My Lightmapping.cginc"
			ENDCG
		}
	}
